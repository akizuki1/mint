...
export default function FaqComponent() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Royalties on Invictus Order will be set at 2.5%. 15% of all of the revenue generated from royalties will go directly to our artist. In the future, we plan to implement dynamic royalties which we believe will promote further accountability from projects in regard to secondary royalties."
    },
    {
